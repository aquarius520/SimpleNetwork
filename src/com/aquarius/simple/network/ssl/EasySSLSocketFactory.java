...
public class EasySSLSocketFactory implements LayeredSocketFactory {
    ...
    public EasySSLSocketFactory(boolean isConnectingYourServer) {
    ...
    private static SSLContext createEasySSLContext() throws IOException {
        try {
            ...
            InputStream clientStream = null; //Application.getContext().getResources().openRawResource(R.raw.production_test_client);
            ...
            instream = null;//Application.getContext().getResources().openRawResource(R.raw.production_test_ca);
